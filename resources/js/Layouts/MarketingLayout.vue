                            ...
                            >
                                <div v-if="toolsDropdownOpen" class="absolute left-1/2 -translate-x-1/2 top-full pt-2 z-50">
                                    <div class="bg-white rounded-xl shadow-lg border border-gray-200 py-2 w-72">
                                        ...
                                        <Link :href="localizedRoute('tools.templates')" class="flex items-center gap-3 px-4 py-2.5 hover:bg-slate-50 transition-colors">
                                            <div class="w-8 h-8 rounded-lg bg-orange-500/10 flex items-center justify-center flex-shrink-0">
                                                <svg class="w-4 h-4 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                                            </div>
                                            <div>
                                                <p class="text-sm font-medium text-slate-900">{{ t('tools.index.templates.title') }}</p>
                                                <p class="text-xs text-slate-500">{{ t('tools.index.templates.description') }}</p>
                                            </div>
                                        </Link>
                ...
                <div v-if="mobileMenuOpen" class="md:hidden py-4 border-t border-gray-200 mt-4">
                    <div class="flex flex-col space-y-3">
                        ...
                        <div class="pl-4 flex flex-col space-y-1">
                            ...
                            <Link :href="localizedRoute('tools.templates')" @click="mobileMenuOpen = false" class="text-xs text-slate-500 hover:text-slate-900 py-1">{{ t('tools.index.templates.title') }}</Link>
            ...
            <div class="mx-auto max-w-6xl px-6 lg:px-8">
                <div class="grid md:grid-cols-5 gap-8 mb-8">
                    <div class="md:col-span-2">
                        ...
                        <!-- Newsletter -->
                        <div v-if="page.props.flash?.success === 'newsletter'" class="flex items-center gap-2 text-sm text-emerald-600 bg-emerald-50 rounded-lg px-3 py-2 max-w-xs">
