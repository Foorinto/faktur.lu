...
// so Googlebot sees it in the initial HTML without executing JS. It used to be
// injected client-side here via onMounted \u2014 which produced structured data only
// after hydration (the same fragility that de-indexed the canonical).
...
<template>
    ...
    <MarketingLayout>
        ...
        <!-- FAIA Validator Banner -->
        <section class="py-10 bg-gradient-to-r from-[#00a896]/5 via-white to-[#00f5d4]/5">
            <div class="mx-auto max-w-6xl px-6 lg:px-8">
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-8 bg-white rounded-2xl border border-[#00f5d4]/30 shadow-sm p-6 sm:p-8">
                    <div class="flex-shrink-0">
                        <div class="w-14 h-14 rounded-2xl bg-[#00f5d4]/10 flex items-center justify-center">
                            <svg class="w-7 h-7 text-[#00a896]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0">
                        <Link
                            ...
                            class="inline-flex items-center gap-2 bg-[#00a896] hover:bg-[#009485] text-white font-semibold px-5 py-2.5 rounded-xl transition-colors text-sm"
                        >
                            {{ t('landing.faia_banner.cta') }}
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 overflow-x-auto">
                        <table class="w-full min-w-[640px]">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                <tr>
                                    <td class="py-3 px-6 text-sm text-slate-700">{{ t('landing.pricing.comparison.rows.revenue_book') }}</td>
                                    <td class="py-3 px-4 text-center text-xs text-slate-500">{{ t('landing.pricing.comparison.rows.revenue_book_free') }}</td>
                                    <td class="py-3 px-4 text-center">
                                        <svg class="w-5 h-5 text-[#00f5d4] mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
                                    </td>
                                    <td class="py-3 px-4 text-center">
