        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <div class="mb-6 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                    ...
                    <ul class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 list-disc list-inside">
                    ...
                    <template v-else>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled
                                class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm dark:border-gray-600 dark:bg-gray-600 dark:text-gray-300"
                            />
                        </div>
