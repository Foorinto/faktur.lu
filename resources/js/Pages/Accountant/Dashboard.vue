...
<template>
    ...
    <AccountantLayout :accountant="accountant">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Mes clients</h1>
        ...
        <div v-if="clients.length === 0" class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-slate-900 dark:text-white">Aucun client</h3>
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
        ...
        <div v-else class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Link
                ...
                class="relative rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 shadow-sm hover:border-primary-500 hover:ring-1 hover:ring-primary-500 transition-all"
            >
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p v-if="client.last_invoice_at" class="mt-1 text-xs text-slate-400">
