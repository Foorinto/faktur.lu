            ...
            <div class="mx-auto max-w-4xl px-6 lg:px-8">
                ...
                <div v-if="file && !result" class="mt-6 text-center">
                    <button
                        ...
                        class="inline-flex items-center gap-2 bg-accent-rose hover:bg-pink-500 disabled:bg-slate-400 text-white font-semibold px-8 py-3.5 rounded-xl transition-colors"
                    >
                ...
                <div v-if="result" class="mt-8 space-y-6">
                    ...
                    <!-- Info -->
                    <div v-if="result.info.length > 0" class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button
                            @click="reset"
                            class="inline-flex items-center gap-2 px-6 py-3 border border-gray-300 rounded-xl text-slate-700 font-medium hover:bg-gray-50 transition-colors"
                        >
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div v-if="!result" class="mt-16">
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="bg-white rounded-xl p-5 border border-gray-200">
                            <div class="w-10 h-10 rounded-lg bg-primary-500/10 flex items-center justify-center mb-3">
                ...
                <!-- FAQ / Info section -->
                <div v-if="!result" class="mt-16 bg-white rounded-2xl border border-gray-200 p-8">
                    ...
                    <div class="prose prose-slate max-w-none">
                        ...
                        <p>
                            <a href="https://pfi.public.lu/fr/e-file/faia.html" target="_blank" rel="noopener noreferrer" class="text-primary-500 hover:underline">
