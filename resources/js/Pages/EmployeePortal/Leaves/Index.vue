...
<template>
    ...
    <EmployeePortalLayout>
        ...
        <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 w-full max-w-lg mx-4">
                ...
                <form @submit.prevent="submitLeave" class="space-y-4">
                    <div>
                        ...
                        <select v-model="form.leave_type_id" class="w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white">
                            <option value="">—</option>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input v-model="form.start_date" type="date" class="w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white" />
                        ...
                        <div>
                            ...
                            <input v-model="form.end_date" type="date" class="w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white" />
                    ...
                    <div>
                        ...
                        <input v-model="form.days_count" type="number" step="0.5" min="0.5" class="w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white" />
                    ...
                    <div>
                        ...
                        <textarea v-model="form.reason" rows="2" class="w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white"></textarea>
                    </div>
