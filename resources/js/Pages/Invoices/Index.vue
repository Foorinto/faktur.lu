                    ...
                    >
                        ...
                        >
                            <div class="flex items-center justify-end gap-1">
                                    <!-- Aperçu, ouverture, modification et
                                         duplication : les icônes communes à
                                         toutes les listes. Finaliser garde son
                                         libellé, c'est l'action principale d'un
                                         brouillon, pas une icône parmi d'autres. -->
                                    <RowAction
                                        icon="preview"
                                        :label="t('preview')"
