    ...
    <AppLayout>
        ...
        <div class="space-y-4">
            ...
            <div
                ...
                class="rounded-2xl bg-white p-12 text-center shadow-xl shadow-gray-200/50 border border-gray-200 dark:bg-surface-card dark:border-gray-700"
            >
                <svg
                        ...
                        <div class="flex-1">
                            ...
                            >
                                ...
                                <span v-if="ticket.latest_message">
                                    ...
                                    {{
                                        formatTimeAgo(
                                            ticket.latest_message.created_at,
                                        )
                                    }}
                                </span>
                                <span
