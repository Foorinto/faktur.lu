...
const props = defineProps({
    ...
    years: Array,
    periods: Array,
    // Ventilation des encaissements par moyen (FEAT-114)
    parMoyenDePaiement: {
        type: Object,
...
<template>
    ...
    <AppLayout>
        ...
        <div class="space-y-6">
            ...
            <div
                v-if="parMoyenDePaiement.lignes.length > 0"
                class="overflow-x-auto rounded-2xl bg-white shadow dark:bg-surface-card"
            >
                <div
                    class="px-6 py-4 border-b border-gray-200 dark:border-gray-700"
                >
                    <h2
                        class="text-lg font-medium text-slate-900 dark:text-white"
                    >
                        {{ t("payments_by_method_title") }}
                    </h2>
                    <!-- Cette ventilation lit les encaissements, pas les
                         factures : une facture réglée en deux fois tombe dans
                         les mois où l'argent est réellement rentré. Les deux
                         totaux peuvent donc différer. -->
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        {{ t("payments_by_method_hint") }}
                    </p>
                </div>
                <div class="overflow-x-auto">
                    ...
                    >
                        ...
                        >
                            <tr
                                v-for="ligne in parMoyenDePaiement.lignes"
                                :key="ligne.method || 'inconnu'"
                            >
                                ...
                                <td
                                    class="whitespace-nowrap px-6 py-3 text-right text-sm text-slate-500 dark:text-slate-400"
                                >
                                    {{ ligne.nombre }}
                                </td>
                                <td
                                ...
                                <td
                                    class="whitespace-nowrap px-6 py-3 text-right text-sm font-semibold text-slate-900 dark:text-white"
                                >
                        ...
                        <tfoot class="bg-slate-50 dark:bg-gray-800">
                            <tr>
                                <td
                                    colspan="3"
                                    class="px-6 py-3 text-sm font-medium text-slate-900 dark:text-white"
                                >
                                    {{ t("total") }}
                                </td>
                                <td
                                    class="whitespace-nowrap px-6 py-3 text-right text-sm font-bold text-slate-900 dark:text-white"
                                >
                                    {{
                                        formatCurrency(parMoyenDePaiement.total)
                                    }}
                                </td>
                            </tr>
                        </tfoot>
                    ...
                    >
                        ...
                        >
                            <tr v-for="vat in vatBreakdown" :key="vat.rate">
                                <td
                                    class="whitespace-nowrap py-4 pl-6 pr-3 text-sm text-slate-900 dark:text-white"
                                >
                                    {{ vat.rate }}%
                                </td>
                                <td
                        ...
                        <tfoot class="bg-slate-50 dark:bg-gray-800">
                            <tr>
                                <td
                                    class="whitespace-nowrap py-3.5 pl-6 pr-3 text-sm font-semibold text-slate-900 dark:text-white"
                                >
                                    {{ t("total") }}
                                </td>
                                <td
                                    class="whitespace-nowrap px-3 py-3.5 text-right text-sm font-semibold text-slate-900 dark:text-white"
                                >
                                    {{ formatCurrency(totals.ht) }}
                                </td>
                                <td
                                    class="whitespace-nowrap py-3.5 pl-3 pr-6 text-right text-sm font-semibold text-slate-900 dark:text-white"
                                >
                                    {{ formatCurrency(totals.vat) }}
                                </td>
                            </tr>
                ...
                <div class="overflow-x-auto">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <td
                                    class="whitespace-nowrap py-4 pl-6 pr-3 text-sm text-slate-500 dark:text-slate-400"
                                >
                                ...
                                <td
                                    class="whitespace-nowrap px-3 py-4 text-sm text-slate-900 dark:text-white"
                                >
                                    {{ invoice.client?.name }}
                                </td>
                                <td
                        ...
                        >
                            <tr>
                                ...
                                <td
                                    class="whitespace-nowrap py-3.5 pl-3 pr-6 text-right text-sm font-bold text-green-600 dark:text-green-400"
                                >
                                    {{ formatCurrency(totals.ttc) }}
                                </td>
                            </tr>
