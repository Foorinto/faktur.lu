        ...
        <div v-if="timer" class="max-w-2xl mx-auto">
            <div class="overflow-hidden rounded-lg bg-gradient-to-r from-primary-500 to-purple-600 shadow-lg">
                <div class="px-8 py-12 text-center">
                    ...
                    <p v-if="timer.project_name" class="text-primary-300">
                        {{ timer.project_name }}
                    </p>
                    <p v-if="timer.description" class="mt-2 text-sm text-primary-200">
                        {{ timer.description }}
                    </p>

                    <button
                        @click="stopTimer"
                        class="mt-8 inline-flex items-center rounded-full bg-white px-8 py-4 text-lg font-semibold text-primary-600 shadow-sm hover:bg-primary-50"
                    >
