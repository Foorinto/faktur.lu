            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <Link
                        ...
                        class="inline-flex items-center rounded-xl bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-200 hover:bg-slate-50 dark:bg-slate-700 dark:text-slate-300 dark:ring-slate-600"
                    >
        ...
        <div class="overflow-hidden rounded-2xl bg-white shadow-xl shadow-slate-200/50 border border-slate-200 dark:bg-slate-800 dark:border-slate-700 dark:shadow-slate-900/50">
            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                ...
                <tbody class="divide-y divide-slate-200 bg-white dark:divide-slate-700 dark:bg-slate-800">
                    ...
                    <tr v-for="lr in leaveRequests.data" :key="lr.id" class="hover:bg-slate-50 dark:hover:bg-slate-700">
                ...
                <div class="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-slate-800">
                    ...
                    <form @submit.prevent="submitNew" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select v-model="newForm.leave_type_id" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="newForm.start_date" type="date" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.end_date') }} *</label>
                                <input v-model="newForm.end_date" type="date" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.business_days_count') }} *</label>
                            <input v-model.number="newForm.days_count" type="number" min="0.5" step="0.5" :max="remainingDays ?? undefined" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" :class="{ 'ring-2 ring-rose-500 dark:ring-rose-500': daysExceeded }" />
                            <div v-if="remainingDays !== null" class="mt-2 flex items-center justify-between rounded-lg px-3 py-2" :class="daysExceeded ? 'bg-rose-50 dark:bg-rose-900/20' : 'bg-slate-50 dark:bg-slate-700/50'">
                        ...
                        <div>
                            ...
                            <textarea v-model="newForm.reason" rows="2" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm"></textarea>
                        </div>
                        <div class="flex justify-end gap-3">
                            ...
                            <button type="submit" :disabled="!canSubmitNew" class="rounded-xl bg-primary-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed">
                                {{ t('hr.submit_request') }}
                            </button>
                        </div>
                    </form>
            ...
            <div v-if="showEditModal" class="fixed inset-0 z-50 flex items-center justify-center">
                ...
                <div class="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-slate-800">
                    ...
                    <form @submit.prevent="submitEdit" class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.leave_type') }} *</label>
                            <select v-model="editForm.leave_type_id" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm">
                                <option value="">{{ t('hr.select_type') }}</option>
                                <option v-for="lt in leaveTypes" :key="lt.id" :value="lt.id">{{ lt.name }}</option>
                            </select>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.start_date') }} *</label>
                                <input v-model="editForm.start_date" type="date" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.end_date') }} *</label>
                                <input v-model="editForm.end_date" type="date" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.business_days_count') }} *</label>
                            <input v-model.number="editForm.days_count" type="number" min="0.5" step="0.5" :max="editRemainingDays ?? undefined" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" :class="{ 'ring-2 ring-rose-500 dark:ring-rose-500': editDaysExceeded }" />
                            <div v-if="editRemainingDays !== null" class="mt-2 flex items-center justify-between rounded-lg px-3 py-2" :class="editDaysExceeded ? 'bg-rose-50 dark:bg-rose-900/20' : 'bg-slate-50 dark:bg-slate-700/50'">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.reason') }}</label>
                            <textarea v-model="editForm.reason" rows="2" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm"></textarea>
                        </div>
                        ...
                        <div class="flex justify-end gap-3">
                            ...
                            <button type="submit" :disabled="!canSubmitEdit" class="rounded-xl bg-primary-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed">
