                ...
                <div class="overflow-hidden rounded-2xl bg-white shadow-xl shadow-slate-200/50 border border-slate-200 dark:bg-slate-800 dark:border-slate-700 dark:shadow-slate-900/50">
                    <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                        ...
                        <tbody class="divide-y divide-slate-200 bg-white dark:divide-slate-700 dark:bg-slate-800">
                            ...
                            <tr v-for="lt in leaveTypes" :key="lt.id" class="hover:bg-slate-50 dark:hover:bg-slate-700">
                                ...
                                <td class="hidden whitespace-nowrap px-3 py-4 text-sm text-center sm:table-cell">
                                    ...
                                    <span v-else class="inline-flex items-center rounded-xl bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-600 dark:bg-slate-700 dark:text-slate-400">{{ t('hr.no') }}</span>
                                </td>
                                <td class="hidden whitespace-nowrap px-3 py-4 text-sm text-center sm:table-cell">
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input v-model="form.default_days_per_year" type="number" min="0" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                        </div>
                        <div class="flex items-center gap-6">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input v-model="form.is_paid" type="checkbox" class="rounded border-slate-300 text-primary-500 focus:ring-primary-500 dark:border-slate-600 dark:bg-slate-700" />
                                <span class="text-sm text-slate-700 dark:text-slate-300">{{ t('hr.paid') }}</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input v-model="form.requires_justification" type="checkbox" class="rounded border-slate-300 text-primary-500 focus:ring-primary-500 dark:border-slate-600 dark:bg-slate-700" />
