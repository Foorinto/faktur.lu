    ...
    <AppLayout>
        ...
        <div class="mb-6 flex flex-wrap gap-3">
            <select
                ...
                @change="applyFilters"
                class="rounded-xl border-0 py-1.5 pl-3 pr-10 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-surface-card dark:text-white dark:ring-slate-600 sm:text-sm"
            >
            ...
            <input
                ...
                class="rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-surface-card dark:text-white dark:ring-slate-600 sm:text-sm"
            />
            <input
                v-model="toFilter"
                @change="applyFilters"
        ...
        <div class="overflow-x-auto rounded-2xl bg-white shadow-xl shadow-gray-200/50 border border-gray-200 dark:bg-surface-card dark:border-gray-700 dark:shadow-gray-900/50">
            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                ...
                <tbody class="divide-y divide-slate-200 bg-white dark:divide-slate-700 dark:bg-surface-card">
                    ...
                    <tr v-for="exp in expenses.data" :key="exp.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
        ...
        <Teleport to="body">
            <div v-if="showNewModal" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
                ...
                <div class="relative w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl dark:bg-surface-card my-8">
                    ...
                    <form @submit.prevent="submitNew" class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select v-model="newForm.expense_category_id" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="newForm.date" type="date" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            ...
                            <div>
                                ...
                                <select v-model="newForm.payment_method" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm">
                                    <option value="">—</option>
                        ...
                        <div>
                            ...
                            <input v-model="newForm.vendor" type="text" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <input v-model="newForm.amount_ht" type="number" step="0.01" min="0.01" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            ...
                            <div>
                                ...
                                <input v-model="newForm.vat_rate" type="number" step="0.01" min="0" max="100" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.amount_ttc') }}</label>
                                <div class="mt-1 flex items-center rounded-xl bg-slate-50 px-3 py-1.5 text-sm font-semibold text-slate-900 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:text-white dark:ring-slate-600">
                        ...
                        <div>
                            ...
                            <textarea v-model="newForm.description" rows="2" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm"></textarea>
                        </div>
                        <!-- Receipts (multi) -->
                        <div>
                            ...
                            <div v-if="newForm.receipts.length > 0" class="mt-1 space-y-1.5">
                                <div v-for="(file, index) in newForm.receipts" :key="index" class="flex items-center justify-between rounded-lg bg-slate-50 px-3 py-2 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:ring-slate-600">
                ...
                <div class="relative w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl dark:bg-surface-card my-8">
                    ...
                    <form @submit.prevent="submitEdit" class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.category') }} *</label>
                                <select v-model="editForm.expense_category_id" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm">
                                    <option value="">{{ t('hr.select_category') }}</option>
                                    <option v-for="cat in categories" :key="cat.id" :value="cat.id">{{ cat.name }}</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.expense_date') }} *</label>
                                <input v-model="editForm.date" type="date" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.vendor') }} *</label>
                                <input v-model="editForm.vendor" type="text" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.payment_method') }}</label>
                                <select v-model="editForm.payment_method" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm">
                                    <option value="">—</option>
                                    <option value="card">{{ t('hr.payment_card') }}</option>
                                    <option value="cash">{{ t('hr.payment_cash') }}</option>
                                    <option value="transfer">{{ t('hr.payment_transfer') }}</option>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.amount_ht') }} *</label>
                                <input v-model="editForm.amount_ht" type="number" step="0.01" min="0.01" required class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.vat_rate') }} (%)</label>
                                <input v-model="editForm.vat_rate" type="number" step="0.01" min="0" max="100" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.amount_ttc') }}</label>
                                <div class="mt-1 flex items-center rounded-xl bg-slate-50 px-3 py-1.5 text-sm font-semibold text-slate-900 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:text-white dark:ring-slate-600">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.description') }}</label>
                            <textarea v-model="editForm.description" rows="2" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white dark:ring-slate-600 sm:text-sm"></textarea>
                        </div>
                        <!-- Existing receipts -->
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.receipts') }}</label>
                            <div v-if="editingExpense?.receipts?.length > 0" class="mt-1 space-y-1.5">
                                <div v-for="receipt in editingExpense.receipts" :key="receipt.id" class="flex items-center justify-between rounded-lg bg-slate-50 px-3 py-2 ring-1 ring-inset ring-gray-200 dark:bg-gray-800 dark:ring-slate-600">
