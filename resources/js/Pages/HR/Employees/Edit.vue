    ...
    <AppLayout>
        ...
        <div class="mx-auto max-w-3xl py-6 px-4 sm:px-6 lg:px-8">
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div v-if="form.status === 'terminated'" class="overflow-hidden rounded-2xl bg-white shadow-xl shadow-slate-200/50 border border-rose-200 dark:bg-slate-800 dark:border-rose-700 dark:shadow-slate-900/50">
                    ...
                    <div class="px-6 py-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.termination_date" type="date" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm" />
                        </div>
                        <div class="sm:col-span-2">
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('hr.termination_reason') }}</label>
                            <textarea v-model="form.termination_reason" rows="3" class="mt-1 block w-full rounded-xl border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-primary-500 dark:bg-slate-700 dark:text-white dark:ring-slate-600 sm:text-sm"></textarea>
                        </div>
                    </div>
                </div>
