                        ...
                        <tbody class="divide-y divide-slate-200 bg-white dark:divide-slate-700 dark:bg-surface-card">
                            ...
                            <tr v-for="cat in categories" :key="cat.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="hidden whitespace-nowrap px-3 py-4 text-sm text-center sm:table-cell">
                                    ...
                                    <span v-else class="inline-flex items-center rounded-xl bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-600 dark:bg-gray-800 dark:text-slate-400">{{ t('hr.inactive') }}</span>
                                </td>
