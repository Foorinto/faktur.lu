...
<template>
    ...
    <AppLayout>
        ...
        <div class="mb-6 border-b border-gray-200 dark:border-gray-700">
            <nav
                class="flex space-x-4 sm:space-x-8 overflow-x-auto"
        ...
        <!-- <div
            ...
            class="mb-6 p-4 bg-pink-50 dark:bg-pink-900/20 border border-pink-200 dark:border-pink-800 rounded-xl"
        >
        ...
        <div
            v-if="page.props.errors?.plan || page.props.errors?.billing_period"
            class="mb-6 p-4 bg-pink-50 dark:bg-pink-900/20 border border-pink-200 dark:border-pink-800 rounded-xl"
        >
            <p class="text-sm text-pink-700 dark:text-pink-300">
                {{ page.props.errors.plan || page.props.errors.billing_period }}
            </p>
        </div>
        ...
        <div class="space-y-6">
            <!-- Current Plan Card -->
            <div
                class="bg-white dark:bg-surface-card rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden"
            >
                <div
                ...
                <div class="p-6">
                    ...
                    >
                        ...
                        <div
                            v-if="(isPro || isEssentiel) && !isOnGracePeriod"
                    ...
                    <div
                        v-if="onTrial"
                        class="mt-4 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl"
                    >
            ...
            >
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div
                            class="h-2 bg-slate-200 dark:bg-gray-800 rounded-full overflow-hidden"
                        >
                            <div
                    ...
                    <div>
                        <div class="flex justify-between text-sm mb-2">
                            ...
                            >
                                ...
                                {{ usage.invoices_this_month.limit }}
                            </span>
                        </div>
                        <div
                            class="h-2 bg-slate-200 dark:bg-gray-800 rounded-full overflow-hidden"
                    ...
                    <div v-if="usage.expenses_this_month">
                        <div class="flex justify-between text-sm mb-2">
                            ...
                            <span
                                class="font-medium text-slate-900 dark:text-white"
                            >
                                {{ usage.expenses_this_month.used }} /
                                {{ usage.expenses_this_month.limit }}
                            </span>
                        </div>
                        <div
                            class="h-2 bg-slate-200 dark:bg-gray-800 rounded-full overflow-hidden"
                    ...
                    <div v-if="usage.active_projects">
                        <div class="flex justify-between text-sm mb-2">
                            ...
                            <span
                                class="font-medium text-slate-900 dark:text-white"
                            >
                                {{ usage.active_projects.used }} /
                                {{ usage.active_projects.limit }}
                            </span>
                        </div>
                        <div
                            class="h-2 bg-slate-200 dark:bg-gray-800 rounded-full overflow-hidden"
            ...
            >
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <!-- Plan Essentiel -->
                        <div
                            class="border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-6 hover:border-primary-300 dark:hover:border-primary-600 transition-colors"
                        >
                            <div class="mb-4">
                                <h3
                                    class="text-xl font-bold text-slate-900 dark:text-white"
                                ...
                                <p
                                    class="text-slate-500 dark:text-slate-400 text-sm mt-1"
                                >
                        ...
                        <!-- Plan Pro (RECOMMANDÉ) -->
                        <div
                            class="border-2 border-primary-500 rounded-2xl p-6 relative bg-primary-50/50 dark:bg-primary-900/10"
                        >
                            <div
                                class="absolute -top-3 left-1/2 -translate-x-1/2"
                            >
                                <span
                                    class="px-3 py-1 text-xs font-bold bg-primary-500 text-white rounded-full"
                                    >RECOMMANDÉ</span
                                >
                            </div>
                            <div class="mb-4">
            ...
            <div
                v-if="isEssentiel && !isOnGracePeriod"
                class="bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl shadow-lg overflow-hidden"
            >
                <div class="p-6">
                    <div
                        class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"
                    >
                        <div class="text-white">
                            ...
                            <p class="mt-2 text-primary-100 text-sm">
                                Débloquez le module RH, le CRM, l'export FAIA,
                                les relances automatiques et bien plus.
                            </p>
                        </div>
                        <form
            ...
            <div
                v-if="(isPro || isEssentiel) && invoices?.length"
                class="bg-white dark:bg-surface-card rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden"
            >
                <div
                    class="px-6 py-4 border-b border-gray-200 dark:border-gray-700"
        ...
        <Teleport to="body">
            ...
            >
                <div class="flex min-h-full items-center justify-center p-4">
                    ...
                    />
                    <div
                        class="relative bg-white dark:bg-surface-card rounded-2xl shadow-xl max-w-md w-full p-6"
                    >
                        <h3
                            class="text-lg font-semibold text-slate-900 dark:text-white"
                        >
                        ...
                        <p class="mt-2 text-slate-600 dark:text-slate-400">
                            ...
                            période de facturation. Après cela, vous passerez
                            automatiquement au plan Gratuit avec des
