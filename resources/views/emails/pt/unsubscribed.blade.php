...
<head>
    ...
    <title>Subscrição cancelada - faktur.lu</title>
    <style>
...
<body>
    <div class="card">
        ...
        <p>Já não vai receber emails da campanha de teste do faktur.lu.</p>
        <p>Os seus dados e a sua conta permanecem intactos.</p>
