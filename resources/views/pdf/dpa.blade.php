...
<head>
    <meta charset="UTF-8">
    <title>Accord de traitement des données - {{ $client['raison_sociale'] }}</title>
    <meta name="robots" content="noindex, nofollow">
    <style>
        body { font-family: sans-serif; margin: 0; padding: 0; line-height: 1.5; color: #0f172a; font-size: 10pt; }
        h1 { font-size: 1.6rem; margin-bottom: 0.25rem; }
        h2 { font-size: 1.15rem; margin-top: 2rem; padding-bottom: 0.3rem; border-bottom: 1px solid #e2e8f0; }
        ...
        .signature-block { width: 100%; margin-top: 2.5rem; }
        .signature-block > div { display: inline-block; width: 47%; vertical-align: top; border-top: 1px solid #cbd5e1; padding-top: 0.5rem; }
        .signature-block > div:first-child { margin-right: 4%; }
        .accept { display: inline-block; margin-top: 0.4rem; color: #047857; font-weight: 600; font-size: 0.85rem; }
        ul { padding-left: 1.5rem; }
        @media print { body { margin: 0; padding: 1.5rem; max-width: none; } a { color: inherit; text-decoration: none; } }
    </style>
</head>
<body>
...
<table>
    ...
    <tr>
        <td>
            <strong>Raison sociale :</strong> {{ $client['raison_sociale'] }}<br>
            <strong>Adresse :</strong> {{ $client['adresse'] }}<br>
            <strong>N° TVA / RCS :</strong> {{ $client['identifiants'] }}<br>
        ...
        <td>
            ...
            <strong>Site :</strong> https://'.config('marque.nom').'/<br>
...
<ul>
    <li>Ne traiter les données que sur instruction documentée du Client (y compris en matière de transfert hors UE) ;</li>
...
<p>Le présent DPA est régi par le droit luxembourgeois. Tout litige relève de la compétence exclusive des tribunaux de Luxembourg-Ville.</p>
...
<ul>
    <li>Chiffrement de toutes les communications via TLS 1.3 (vérifiable publiquement)</li>
    <li>HSTS activé, redirection HTTP → HTTPS systématique</li>
</ul>

<h3>Sécurité au repos</h3>
<ul>
...
<ul>
    <li>Journaux d'application (logs serveur) conservés 30 jours pour analyse incident</li>
    <li>Journal d'audit des actions sensibles (connexion, modification facture, suppression) consultable par le Client dans l'interface</li>
</ul>
...
<div class="signature-block">
    ...
    <div>
        ...
        Alexandre Beaudier<br>
        Exploitant<br>
        <span class="accept">Engagé au titre de la version {{ $acceptation['version'] }} du présent accord</span><br>
        <span class="meta">Document délivré le {{ $genereLe }}</span>
    </div>
</div>
