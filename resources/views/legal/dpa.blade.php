...
<head>
    ...
    <style>
        ...
        .signature-block { display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-top: 3rem; }
        .signature-block div { border-top: 1px solid #cbd5e1; padding-top: 0.5rem; min-height: 5rem; }
...
<table>
    ...
    <tr>
        <td>
            <strong>Raison sociale :</strong> ___________________________<br>
            <strong>Adresse :</strong> ___________________________<br>
            <strong>N° TVA / RCS :</strong> ___________________________<br>
            <strong>Contact :</strong> ___________________________<br>
