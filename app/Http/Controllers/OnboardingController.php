...
class OnboardingController extends Controller
{
    ...
    public function saveCompany(Request $request)
    {
        ...
        $autorisationExigee = BusinessSettings::exerciseFormRequiresEstablishmentAuthorization($request->input('exercise_form'), $request->boolean('no_establishment_authorization'))
