...
class SitemapController extends Controller
{
    ...
    protected function generatePagesSitemap(): string
    {
        ...
        $pages = [
            ...
            ['route' => 'for_accountants', 'priority' => '0.9', 'changefreq' => 'monthly'],
            ...
            ['route' => 'tools.vat_calculator', 'priority' => '0.8', 'changefreq' => 'monthly'],
            ['route' => 'tools.vat_exemption', 'priority' => '0.8', 'changefreq' => 'monthly'],
            ['route' => 'tools.iban_validator', 'priority' => '0.8', 'changefreq' => 'monthly'],
