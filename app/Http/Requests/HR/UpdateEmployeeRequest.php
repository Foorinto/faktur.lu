...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $nullableFields = [
            ...
            'termination_date', 'department_id', 'manager_id', 'salary_gross',
        ];
    ...
    public function rules(): array
    {
        return [
            ...
            'contract_type' => ['sometimes', 'required', Rule::in(Employee::CONTRACT_TYPES)],
            'contract_start' => ['sometimes', 'required', 'date'],
            'contract_end' => ['nullable', 'date', 'after_or_equal:contract_start'],
            'trial_end_date' => ['nullable', 'date', 'after_or_equal:contract_start'],
            'job_title' => ['nullable', 'string', 'max:100'],
            'department_id' => ['nullable', Rule::exists('departments', 'id')->where('user_id', auth()->id())],
            'manager_id' => ['nullable', Rule::exists('employees', 'id')->where('user_id', auth()->id())],
